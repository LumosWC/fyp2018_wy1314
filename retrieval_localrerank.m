function [ranks,querytime] = retrieval_localrerank(image,net,Xm, eigvec, eigval,vecs,conv3d,gnd_test,show_img)
...
figure;
for i = 1 : 20
    [image , map ] = imread (strcat ('/Users/wc/Desktop/CBIR CCTV/Paris6k_dataset/paris_images/',char (gnd_test.imlist(ranks_rerank(i))),'.jpg'));
