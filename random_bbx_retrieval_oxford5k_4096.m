...
qvecs_128 = pca_reduce_oxford5k' * qvecs ; 
[sim,ranks] = sort(fc128_oxford5k'*qvecs_128, 'descend');
map = compute_map (ranks, gnd_oxford5k.gnd);
...
title (strcat('query',string(query),'Correspondence Number',string(numel(gnd_oxford5k.gnd(query).ok))));
