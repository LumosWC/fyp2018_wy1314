...
main_folder = '/home/wy1314/CBIR_CCTV/'; % oxford5k/ and paris6k/ should be in here
...
qim = arrayfun(@(x) crop_qim([dataset_folder, qimlist{x}, '.jpg'], random_bbx(x,:)), 1:numel(gnd_paris6k.qidx), 'un', 0);
